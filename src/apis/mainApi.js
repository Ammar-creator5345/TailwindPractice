...
// https://api.ziphire.hr/v2/developer/profile-completion/
// https://api.ziphire.hr/v2/developer/applications/application-stats

// https://api.ziphire.hr/v2/developer/profile
// https://api.ziphire.hr/v2/developer/past_projects
// https://api.ziphire.hr/v2/developer/education
// https://api.ziphire.hr/v2/developer/certificate

// https://api.ziphire.hr/v2/developer/work_history
// https://api.ziphire.hr/v2/developer/language

// https://api.ziphire.hr/v2/developer/hobbies
// https://api.ziphire.hr/v2/developer/personal_info

// https://api.ziphire.hr/v2/developer/about_me
// https://api.ziphire.hr/v2/developer/skills

// https://api.ziphire.hr/v2/developer/profile-completion/
// https://api.ziphire.hr/v2/developer/applications/application-stats

// https://api.ziphire.hr/v2/developer/publications
// https://api.ziphire.hr/v2/countries?ordering=label
// https://api.ziphire.hr/v2/developer/past_projects
...
// https://api.ziphire.hr/v2/languages
...
// https://api.ziphire.hr/v2/developer/job_types
// https://api.countrystatecity.in/v1/countries/PK/cities

// https://api.ziphire.hr/v2/developer/work_modes
// https://api.ziphire.hr/v2/developer/about_me

// https://api.ziphire.hr/v2/developer/publications
// https://api.ziphire.hr/v2/technologies?ordering=label
// https://api.ziphire.hr/v2/developer/skills
// https://api.ziphire.hr/v2/developer/get-recommended-skills?exclude_skills=&developer_id=true

// https://api.countrystatecity.in/v1/countries/BH/cities
